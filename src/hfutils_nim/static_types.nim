...
proc capacity*[N: static int](s : StaticString) : int = N
...
proc fromJson*[N: static int](j : JsonNode) : StaticString[N] =
    return toStatic[N](j.getStr)
...
proc capacity*[N: static int, T](s : StaticSeq) : int {.inline.} = N
...
when isMainModule:
    var
        x : StaticTable[10, StaticString[32], StaticString[64]]
